...
namespace Fluent
{
    ...
    public class OptionsPresenter : MonoBehaviour
    {
        ...
        {
            DialogUI = GameObject.Find("/GameManager/DialogueBox/Dialog With Response");
            OptionsPanel = GameObject.Find("/GameManager/DialogueBox/Dialog With Response/Scroll View/Viewport/ScrollablePanel/OptionsPanel");
